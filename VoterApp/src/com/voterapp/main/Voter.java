...
public class Voter {
	...
	public static void main(String[] args) throws UnderAgeException, LocalityNotFoundException, NoVoterIdException {
		try 
		{
		...
		boolean status = eb.checkElegibility(age, locality, vid);
		if(status) {
